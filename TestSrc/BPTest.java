...
/*-----------------------------------------------------------------------------------------------------------------------*/
    ...
    public static void ApplicationTest(String testcaseName, String keyword, String objectName, String value, String Expected)
            throws Exception {
...
Thread.sleep(5000);
                         ...
                         List<WebElement> FN=driver.findElements(By.xpath("//div[@class='container-fluid']//div/label"));

                         for(WebElement Fb:FN)
                         {
                             String g=Fb.getText();
                ...
                case"CLICK":
                {
                    switch (objectName)
                    {
                        case"Create":
                            ...
                            driver.findElement(By.xpath(".//*[@id='btnNewApplication']")).click();
break;
                    }
                }
                break;
